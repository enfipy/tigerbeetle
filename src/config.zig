...
// TODO: Some of these could be runtime parameters (e.g. grid_scrubber_cycle).
const ConfigProcess = struct {
    ...
    connection_delay_min: stdx.Duration = .ms(50),
    connection_delay_max: stdx.Duration = .ms(1000),
    tcp_backlog: u31 = 64,
    ...
    client_replies_iops_write_max: u16 = 2,
    tick_ms: u63 = 10,
    rtt: stdx.Duration = .ms(300),
    rtt_max: stdx.Duration = .seconds(60),
    rtt_multiple: u8 = 2,
    backoff_min: stdx.Duration = .ms(10),
    backoff_max: stdx.Duration = .ms(10000),
    clock_offset_tolerance_max: stdx.Duration = .ms(10000),
    ...
    multiversion_poll_interval: stdx.Duration = .ms(1000),
};
