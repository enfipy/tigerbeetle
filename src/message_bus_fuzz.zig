...
pub fn main(gpa: std.mem.Allocator, args: fuzz.FuzzArgs) !void {
    ...
    const configuration = &.{
        try std.Io.net.IpAddress.parseIp4("127.0.0.1", 3000),
        try std.Io.net.IpAddress.parseIp4("127.0.0.1", 3001),
        try std.Io.net.IpAddress.parseIp4("127.0.0.1", 3002),
    };
...
const IO = struct {
    ...
    const Operation = union(enum) {
        ...
        connect: struct { socket: socket_t, address: std.Io.net.IpAddress },
