...
fn build_scripts(
    ...
    scripts_exe.root_module.link_libc = true;
...
fn build_node_client(
    ...
    for (Platform.all) |platform| {
        ...
        node_api.addSystemIncludePath(b.path(
            "src/clients/node/node_modules/node-api-headers/include",
        ));
        root_module.addImport("node_api", node_api.createModule());
...
const Generated = struct {
    ...
    pub fn file(b: *std.Build, options: struct {
        ...
        return create(
            b,
            options.path,
            b.addRunArtifact(options.generator).captureStdOut(.{
    ...
    fn create(b: *std.Build, destination: []const u8, source: std.Build.LazyPath) *Generated {
        ...
        const step = if (b.graph.environ_map.get("CI") != null) step: {
            ...
            if (std.mem.endsWith(u8, destination, "/")) {
                ...
                update.setName(b.fmt("update generated {s}", .{destination}));
                update.addFileArg(source);
                update.addArg(destination);
